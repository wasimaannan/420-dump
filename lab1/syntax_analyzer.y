...
//  %token IF ELSE FOR
%token IF ELSE FOR WHILE DO BREAK CONTINUE RETURN INT FLOAT CHAR VOID DOUBLE SWITCH CASE DEFAULT PRINTF ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD SEMICOLON COMMA ID CONST_INT CONST_FLOAT GOTO COLON 
...
int main(int argc, char *argv[])
{
	...
	yyparse();
	outlog << "Total lines parsed: " << lines << endl;
